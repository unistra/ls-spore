...
(function(){
  var SporeRequest, SporeMethodsFactory, Spore, out$ = typeof exports != 'undefined' && exports || this;
  SporeRequest = (function(){
    ...
    SporeRequest.prototype.call = function(success, error){
    ...
    SporeRequest.prototype._generateUrlTemplate = function(){
      var urlTemplate;
    ...
    SporeRequest.prototype._generateFinalUrl = function(urlTemplate){
    ...
    SporeRequest.prototype._doRequest = function(url, success, error){
  ...
  SporeMethodsFactory = (function(){
    ...
    SporeMethodsFactory.prototype.createMethod = function(name, desc, env, middlewares){
      var method;
  ...
  Spore = (function(){
    ...
    Spore.prototype.create = function(success, error){
      var xhr, this$ = this;
      xhr = new XMLHttpRequest;
    ...
    Spore.prototype.enable = function(middlewareClass, params){
      return this.enableIf(function(request){
        return true;
      }, middlewareClass, params);
    };
    Spore.prototype.enableIf = function(predicate, middlewareClass, params){
    ...
    Spore.prototype.logBasicInfos = function(){
    ...
    Spore.prototype._generateMethods = function(methods){
    ...
    Spore.prototype._generateMethodsEnv = function(methodKey, methodValue){
      var url_parser;
    ...
    Spore.prototype._getAuthentication = function(methodAuthentication){
    ...
    Spore.prototype._getPathInfo = function(script_name, pathname, method_path){
      var res;
      res = "";
    ...
    Spore.prototype._getRequestMethod = function(method){
    ...
    Spore.prototype._getScriptName = function(pathname){
      var slice;
    ...
    Spore.prototype._getServerPort = function(url_parser){
      var port;
      port = 80;
    ...
    Spore.prototype._callCallback = function(response, callback){
      this.description = response;
      this._generateMethods(this.description.methods);
      this.isReady = true;
      return callback();
    };
    Spore.prototype._getBaseUrl = function(value){
